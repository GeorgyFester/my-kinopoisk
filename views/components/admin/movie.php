...
<tr>
    ...
    <td><span><?php echo $movie->avgRating() ?></span></td>
    <td>
        <div>
            <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Действия </a>
            <ul>
                <li>
                    <a href="/admin/movies/update?id=<?php echo $movie->id() ?>">
